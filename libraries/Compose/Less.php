...
class lessc {
	...
	protected function newFormatter() {
		$className = "\Compose\lessc_formatter_lessjs";
		if (!empty($this->formatterName)) {
			if (!is_string($this->formatterName))
				return $this->formatterName;
			$className = "\Compose\lessc_formatter_$this->formatterName";
		}
	...
	protected function addParsedFile($file) {
		if (stristr($file,'http') != FALSE) {
			$this->allParsedFiles[realpath($file)] = time();
		} else {
...
class lessc_parser {
	...
	public function __construct($lessc, $sourceName = null) {
		...
		if (!self::$operatorString) {
			self::$operatorString =
				'('.implode('|', array_map(array('\Compose\lessc', 'preg_quote'),
	...
	protected function isDirective($dirname, $directives) {
		...
		$pattern = implode("|",
			array_map(array("\Compose\lessc", "preg_quote"), $directives));
	...
	protected function openString($end, &$out, $nestingOpen=null, $rejectStrs = null) {
		...
		$stop = array("'", '"', "@{", $end);
		$stop = array_map(array("\Compose\lessc", "preg_quote"), $stop);
