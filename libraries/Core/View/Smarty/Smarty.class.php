...
class Smarty extends Smarty_Internal_TemplateBase {
    ...
    {
        $allowed = array(
        'template_dir_prefix' => 'setTemplateDirPrefix',
    ...
    public function setTemplateDirPrefix($_dir_prefix) {
    	$this->template_dir_prefix = $_dir_prefix;
    }
